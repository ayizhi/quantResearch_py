...
if __name__ == '__main__':
	...
	for i in range(len(stocker_ids)):
		...
		if (mean_price_5 > mean_price_30) and (mean_price_30 > mean_price_70) :
			if current_price < mean_price_5 :
...
>>>>>>> 68e6fe70681861c5836b326722ad258a71a9f888
